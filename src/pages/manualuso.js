...
<div className="contenido">
        <h3 className="titulo3">INTRODUCCIÓN</h3>
        ...
        <h3 className="titulo3"> INICIO DE SESIÓN</h3>
        ...
        <h3 className="titulo3">PANEL DE CONTROL </h3>
        ...
        <h3 className="titulo3">CREACIÓN DE CÓDIGOS QR</h3>
        ...
        <h3 className="titulo3">OPCIONES AVANZADAS</h3>
